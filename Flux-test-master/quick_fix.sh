...
# Quick OAuth Fix - Run from /app/Flasqo directory
...
if [ ! -f "backend/.env" ]; then
    ...
    echo "Make sure you're in the /app/Flasqo directory"
    pwd
    exit 1
fi
...
# Set production URLs
update_env_var "BACKEND_URL" "https://Flasqo.evolune.in"
update_env_var "FRONTEND_URL" "https://Flasqo.evolune.in"
update_env_var "ALLOWED_ORIGINS" "https://Flasqo.evolune.in"
...
cd frontend
export VITE_API_BASE_URL="https://Flasqo.evolune.in"
rm -rf dist
npm install --silent
npm run build
...
sudo systemctl status Flasqo-backend --no-pager | head -10
...
echo "   https://Flasqo.evolune.in/auth/google/callback"
echo "   At: https://console.cloud.google.com/apis/credentials"
echo ""
echo "2. GitHub OAuth Callback URL:"
echo "   https://Flasqo.evolune.in/auth/github/callback"
echo "   At: https://github.com/settings/developers"
echo ""
echo "Now test at: https://Flasqo.evolune.in"
echo ""
echo "View logs: sudo journalctl -u Flasqo-backend -f"
echo ""
