...
function TestingTypesLanding({ user, onLogout }) {
  ...
  const testingTypes = [
    ...
    },
    {
      ...
      docsHref: "/guides/regression-testing/",
      color: "cyan",
    },
    {
      id: "contract",
    ...
    },
    {
      ...
      docsHref: "/guides/auto-discovery/",
      color: "emerald",
    },
    {
      id: "vibe-testing",
    ...
    },
    {
      ...
      docsHref: "/guides/integration-testing/",
      color: "purple",
      badge: "NEW",
    },
    {
    ...
    // PROD-GATE: card entry (remove this object to disable the module card)
    {
      ...
      docsHref: "/guides/production-gate/",
      color: "blue",
      badge: "NEW",
      newTab: true,
    },
