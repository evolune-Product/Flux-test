    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 text-white">
      ...
      <main className="max-w-6xl mx-auto px-6 py-8 space-y-6">
          ...
          {currentStep === 3 && (
            <div className="space-y-5">
              <div>
                <h1 className="text-2xl font-bold text-white">Generate AI Tests</h1>
                <p className="text-sm text-slate-400 mt-1">Let AI create intelligent test cases for your API</p>
              </div>
